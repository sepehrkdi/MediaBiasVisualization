...
export class BaseChart {
    ...
    updateDimensions() {
        ...
        // Use offsetWidth/offsetHeight as fallback for more reliable dimensions
        const containerWidth = containerRect.width || this.container.offsetWidth || 600;
        const containerHeight = containerRect.height || this.container.offsetHeight || 400;

        this.width = containerWidth - this.options.margin.left - this.options.margin.right;
        this.height = containerHeight - this.options.margin.top - this.options.margin.bottom;
